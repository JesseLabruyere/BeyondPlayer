...
app.factory("sharedService", function($rootScope) {
    ...
    $scope.functions = {}, $scope.queueData = [], $scope.selected = {}, $scope.functions.loadQueue = function(item, event) {}, 
    $scope.functions.loadQueue(), $scope.$on("queue", function() {
        $scope.queueData = sharedService.songQueue, $scope.selected = $scope.queueData[0], 
