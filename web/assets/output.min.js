...
$(document).ready(function() {}), app.factory("sharedService", function($rootScope) {
...
}), app.controller("uploadController", function($scope) {}), app.controller("uploadsController", function($scope, $http, $routeParams) {
    $scope.functions = {}, $scope.functions.loadUploadsView = function(item, event) {
        ...
        response.success(function(data, status, headers, config) {
            ...
            void 0 !== data.playlists && ($scope.playlists = data.playlists));
