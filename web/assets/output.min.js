...
$(document).ready(function() {}), app.factory("sharedService", function($rootScope, $q, $http) {
    ...
    sharedService.broadcast = function(message) {
    ...
    }, sharedService.paginationInfo = {}, sharedService.initiatePagination = function(totalItems, pageNumber, viewName, numPages, itemsPerPage) {
        ...
        sharedService.paginationInfo.viewName = viewName, sharedService.paginationInfo.numPages = numPages, 
...
}), app.controller("uploadController", function($scope) {}), app.controller("uploadsController", function($scope, $http, $timeout, $routeParams, sharedService) {
    $scope.functions = {}, $scope.playlists = [], $scope.itemsPerPage = 25, $scope.currentPage = $routeParams.pageNumber, 
    ...
    }, $scope.functions.loadUploadsView(), $scope.functions.removeItem = function(id, index) {
    ...
    $scope.functions = {}, $scope.totalItems = 50, $scope.currentPage = 1, $scope.viewName = "uploads", 
    ...
    $scope.functions.selectPage = function() {
        ...
        $scope.viewName = sharedService.paginationInfo.viewName, $scope.numPages = sharedService.paginationInfo.numPages, 
