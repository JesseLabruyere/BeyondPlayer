...
$(document).ready(function() {}), app.factory("sharedService", function($rootScope) {
    var sharedService = {};
    return sharedService.songQueue = [], sharedService.setSongQueue = function(data) {
...
}), app.controller("uploadController", function($scope) {}), app.controller("uploadsController", function($scope, $http, $timeout, $routeParams) {
    $scope.functions = {}, $scope.functions.loadUploadsView = function(item, event) {
        var response = $http.get("app/getUploads");
        response.success(function(data, status, headers, config) {
            void 0 !== data.uploads && data.success && ($scope.songs = data.uploads.listItems, 
            void 0 !== data.playlists && ($scope.playlists = data.playlists)), $timeout(function() {
        ...
        response.success(function(data, status, headers, config) {
            data.success && (alert("Upload removed"), $scope.functions.removeItemFromData(index));
        }), response.error(function(data, status, headers, config) {
            alert("AJAX failed!");
        });
    ...
    $scope.functions = {}, $scope.functions.loadPlaylistView = function(item, event) {
        ...
        sharedService.setSongQueue($scope.songs), sharedService.broadcast("queue");
    };
