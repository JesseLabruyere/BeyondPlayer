...
$(document).ready(function() {
    ...
    $scope.functions = {}, $scope.songQueue = [], $scope.selected = {};
    var player;
    $scope.functions.loadQueue = function(item, event) {}, $scope.functions.loadQueue(), 
    $scope.$on("queue", function() {
        $scope.songQueue = sharedService.songQueue, $scope.selected = $scope.songQueue[0], 
    ...
    }), $scope.functions.nextSong = function(item, event) {}, $scope.functions.buildMediaPlayer = function() {
