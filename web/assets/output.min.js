...
$(document).ready(function() {}), app.factory("sharedService", function($rootScope, $q, $http) {
    ...
    $scope.pages = 0, $scope.functions.loadUploadsView = function(item, event) {
        ...
        response.success(function(data, status, headers, config) {
            ...
            $scope.playlists = sharedService.playlists, "undefined" != typeof $scope.currentPage && ($scope.args = {
    ...
    $scope.functions = {}, $scope.functions.setDefaults = function() {
        $scope.totalItems = 50, $scope.currentPage = 1, $scope.numPages = 20, $scope.itemsPerPage = 25, 
        $scope.maxSize = 5, $scope.paginationShown = !1;
    }, $scope.functions.setDefaults(), $scope.functions.pageChanged = function() {
        $location.path($location.path()).search({
            page: $scope.currentPage
        });
    }, $scope.$on("topOptionsController.initiatePagination", function(event, args) {
        $scope.totalItems = args.totalItems, $scope.currentPage = args.currentPage, $scope.numPages = args.numPages, 
        $scope.itemsPerPage = args.itemsPerPage, $scope.maxSize = "undefined" != typeof args.maxSize ? args.maxSize : 5, 
        $scope.paginationShown = "undefined" != typeof args.paginationShown ? args.paginationShown : !0;
