function assignFormHandlers() {
    $(document).on("submit", "#upload_form", function(e) {
        e.preventDefault(), $("#upload_form").ajaxSubmit(function() {
            alert("Thank you for your upload!");
        });
    }), $(document).on("submit", "#registration_form", function(e) {
        e.preventDefault(), $("#registration_form").ajaxSubmit(function() {
...
app.directive("leftMenuDirective", function() {
    var linkFn = function($scope, $http) {
        $scope.functions = {}, $scope.functions.loadUploadPage = function(item, event) {
            ...
            response.success(function(data, status, headers, config) {
                $("#pageCenter").html(data), setAjaxForm("#registration_form");
            }), response.error(function(data, status, headers, config) {
                alert("AJAX failed!");
            });
        };
