...
$(document).ready(function() {}), app.factory("sharedService", function($rootScope, $q, $http) {
    ...
    $scope.$on("queue", function() {
        ...
        $scope.indexHighLighted === songIndex ? $scope.index !== songIndex && $scope.functions.playSong(songIndex) : $scope.indexHighLighted = songIndex;
        ...
        })) : $scope.functions.emptyQueue() : $scope.songQueue.splice(songIndex, 1);
