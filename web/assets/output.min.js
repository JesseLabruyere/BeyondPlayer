...
if (function(T, V, s) {
    ...
    function F(b) {
        return function() {
            var c, a = arguments[0];
            for (c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.16/" + (b ? b + "/" : "") + a, 
    ...
    function Sa(b) {
        ...
        return b.nodeType === ma && a ? !0 : O(b) || w(b) || 0 === a || "number" == typeof a && a > 0 && a - 1 in b;
    }
    function q(b, a, c) {
        var d, e;
    ...
    function Ba(b, a, c, d) {
        ...
        if (a) {
            ...
            if (w(b)) for (var f = a.length = 0; f < b.length; f++) e = Ba(b[f], null, c, d), 
            I(b[f]) && (c.push(b[f]), d.push(e)), a.push(e); else {
                var g = a.$$hashKey;
                w(a) ? a.length = 0 : q(a, function(b, c) {
                    delete a[c];
                });
                for (f in b) b.hasOwnProperty(f) && (e = Ba(b[f], null, c, d), I(b[f]) && (c.push(b[f]), 
                d.push(e)), a[f] = e);
                qc(a, g);
            }
        } else (a = b) && (w(b) ? a = Ba(b, [], c, d) : ea(b) ? a = new Date(b.getTime()) : Ua(b) ? (a = new RegExp(b.source, b.toString().match(/[^\/]*$/)[0]), 
    ...
    function Md(b, a) {
        var c = a;
        return "string" == typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = s : Ta(a) ? c = "$WINDOW" : a && V === a ? c = "$DOCUMENT" : Va(a) && (c = "$SCOPE"), 
        c;
    }
    function $a(b, a) {
        return "undefined" == typeof b ? s : (Q(a) || (a = a ? 2 : null), JSON.stringify(b, Md, a));
    }
    function tc(b) {
    ...
    function vc(b) {
        ...
        return q((b || "").split("&"), function(b) {
            b && (c = b.replace(/\+/g, "%20").split("="), d = uc(c[0]), y(d) && (b = y(c[1]) ? uc(c[1]) : !0, 
            wc.call(a, d) ? w(a[d]) ? a[d].push(b) : a[d] = [ a[d], b ] : a[d] = b));
        }), a;
    }
    function Qb(b) {
        var a = [];
    ...
    function Nd(b, a) {
        var c, d, e = tb.length;
        for (b = z(b), d = 0; e > d; ++d) if (c = tb[d] + a, O(c = b.attr(c))) return c;
        return null;
    }
    function Od(b, a) {
        var c, d, e = {};
    ...
    function xc(b, a, c) {
        ...
        var d = function() {
            ...
            } ]), a.unshift("ng"), d = bb(a, c.strictDi), d.invoke([ "$rootScope", "$rootElement", "$compile", "$injector", function(a, b, c, d) {
                a.$apply(function() {
                    b.data("$injector", d), c(b)(a);
                });
            } ]), d;
        }, e = /^NG_ENABLE_DEBUG_INFO!/, f = /^NG_DEFER_BOOTSTRAP!/;
        return T && e.test(T.name) && (c.debugInfoEnabled = !0, T.name = T.name.replace(e, "")), 
        T && !f.test(T.name) ? d() : (T.name = T.name.replace(f, ""), ba.resumeBootstrap = function(b) {
            return q(b, function(b) {
                a.push(b);
            }), d();
        }, void (E(ba.resumeDeferredBootstrap) && ba.resumeDeferredBootstrap()));
    }
    function Pd() {
        T.name = "NG_ENABLE_DEBUG_INFO!" + T.name, T.location.reload();
    }
    function Qd(b) {
        if (b = ba.element(b).injector(), !b) throw Ja("test");
        return b.get("$$testability");
    }
    function yc(b, a) {
        return a = a || "_", b.replace(Rd, function(b, d) {
    ...
    function Sd() {
        ...
        zc || ((pa = T.jQuery) && pa.fn.on ? (z = pa, x(pa.fn, {
            ...
            var c;
            if (Rb) Rb = !1; else for (var e, d = 0; null != (e = a[d]); d++) (c = pa._data(e, "events")) && c.$destroy && pa(e).triggerHandler("$destroy");
            b(a);
    ...
    function La(b, a, c) {
        return c && w(b) && (b = b[b.length - 1]), Sb(E(b), a, "not a function, got " + (b && "object" == typeof b ? b.constructor.name || "Object" : typeof b)), 
        b;
    }
    function Ma(b, a) {
    ...
    function Td(b) {
        ...
        return b = a(b, "angular", Object), b.$$minErr = b.$$minErr || F, a(b, "module", function() {
            var b = {};
    ...
    function Ud(b) {
        ...
        db("ng", [ "ngLocale" ], [ "$provide", function(a) {
            a.provider({
                ...
                ngInclude: Fe
            }).directive(wb).directive(Hc), a.provider({
                $anchorScroll: Ge,
                $animate: He,
                $browser: Ie,
                $cacheFactory: Je,
    ...
    function eb(b) {
        return b.replace(hf, function(a, b, d, e) {
            return e ? d.toUpperCase() : d;
        }).replace(jf, "Moz$1");
    }
    function Jc(b) {
        return b = b.nodeType, b === ma || !b || 9 === b;
    }
    function Kc(b, a) {
        var c, d, e = a.createDocumentFragment(), f = [];
        if (Tb.test(b)) {
            for (c = c || e.appendChild(a.createElement("div")), d = (kf.exec(b) || [ "", "" ])[1].toLowerCase(), 
            d = ha[d] || ha._default, c.innerHTML = d[1] + b.replace(lf, "<$1></$2>") + d[2], 
    ...
    function R(b) {
        ...
        var a;
        if (O(b) && (b = U(b), a = !0), !(this instanceof R)) {
    ...
    function Mc(b, a, c, d) {
        ...
        if (f) if (a) q(a.split(" "), function(a) {
            if (y(c)) {
                var d = e[a];
    ...
    function yb(b, a) {
        ...
        Mc(b)), delete Ab[c], b.ng339 = s));
    }
    function zb(b, a) {
        var c = b.ng339, c = c && Ab[c];
        return a && !c && (b.ng339 = c = ++nf, c = Ab[c] = {
            events: {},
            data: {},
            handle: s
        }), c;
    ...
    function Eb(b, a, c) {
        for (9 == b.nodeType && (b = b.documentElement), a = w(a) ? a : [ a ]; b; ) {
            for (var d = 0, e = a.length; e > d; d++) if ((c = z.data(b, a[d])) !== s) return c;
    ...
    function of(b, a) {
        a = a || T, "complete" === a.document.readyState ? a.setTimeout(b) : z(a).on("load", b);
    }
    function Qc(b, a) {
    ...
    function Na(b, a) {
        var c = b && b.$$hashKey;
        return c ? ("function" == typeof c && (c = b.$$hashKey()), c) : (c = typeof b, c = "function" == c || "object" == c && null !== b ? b.$$hashKey = c + ":" + (a || Kd)() : c + ":" + b);
    }
    function fb(b, a) {
        if (a) {
            var c = 0;
    ...
    function bb(b, a) {
        function c(a) {
            return function(b, c) {
                return I(b) ? void q(b, pc(a)) : a(b, c);
            };
        }
        function d(a, b) {
            if (Ma(a, "service"), (E(b) || w(b)) && (b = n.instantiate(b)), !b.$get) throw Da("pget", a);
        ...
        function g(a) {
            ...
            return q(a, function(a) {
                ...
                if (!m.get(a)) {
                    m.put(a, !0);
                    try {
                        O(a) ? (c = db(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), 
                        d(c._configBlocks)) : E(a) ? b.push(n.invoke(a)) : w(a) ? b.push(n.invoke(a)) : La(a, "module");
                    } catch (e) {
        ...
        function h(b, c) {
            ...
            function e(b, c, f, g) {
                ...
                var h, n, m, k = [], l = bb.$$annotate(b, a, g);
                for (n = 0, h = l.length; h > n; n++) {
                    if (m = l[n], "string" != typeof m) throw Da("itkn", m);
                    k.push(f && f.hasOwnProperty(m) ? f[m] : d(m, g));
                }
                return w(b) && (b = b[h]), b.apply(c, k);
            }
            return {
                invoke: e,
                instantiate: function(a, b, c) {
                    var d = Object.create((w(a) ? a[a.length - 1] : a).prototype || null);
                    return a = e(a, d, b, c), I(a) || E(a) ? a : d;
                },
                get: d,
        ...
        this.disableAutoScrolling = function() {
            ...
            function f(b) {
                if (b) {
                    b.scrollIntoView();
                    var c;
                    c = g.yOffset, E(c) ? c = c() : rc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : Q(c) || (c = 0), 
    ...
    function sf(b, a, c, d) {
        ...
        function h() {
            ...
            M = C(M) ? null : M, fa(M, S) && (M = S), S = M;
        }
        function l() {
            (G !== m.url() || D !== M) && (G = m.url(), D = M, q($, function(a) {
                a(m.url(), M);
            }));
        }
        function k(a) {
        ...
        m.addPollFn = function(a) {
            return C(B) && f(100, v), J.push(a), a;
        };
        var M, D, G = n.href, N = a.find("base"), Y = null;
        h(), D = M, m.url = function(a, c, e) {
            if (C(e) && (e = null), n !== b.location && (n = b.location), u !== b.history && (u = b.history), 
            a) {
                var f = D === e;
                if (G === a && (!d.history || f)) return m;
                var g = G && Ea(G) === Ea(a);
                return G = a, D = e, !d.history || g && f ? (g || (Y = a), c ? n.replace(a) : g ? (c = n, 
                e = a.indexOf("#"), a = -1 === e ? "" : a.substr(e + 1), c.hash = a) : n.href = a) : (u[c ? "replaceState" : "pushState"](e, "", a), 
                h(), D = M), m;
            }
        ...
        m.onUrlChange = function(a) {
            return W || (d.history && z(b).on("popstate", g), z(b).on("hashchange", g), W = !0), 
            $.push(a), a;
        ...
        m.cookies = function(a, b) {
            var d, e, f, g;
            if (!a) {
                if (r.cookie !== y) for (y = r.cookie, d = y.split("; "), Fa = {}, f = 0; f < d.length; f++) e = d[f], 
                g = e.indexOf("="), g > 0 && (a = k(e.substring(0, g)), Fa[a] === s && (Fa[a] = k(e.substring(g + 1))));
                return Fa;
            }
            b === s ? r.cookie = encodeURIComponent(a) + "=;path=" + hb + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : O(b) && (d = (r.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + hb).length + 1, 
            d > 4096 && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
        }, m.defer = function(a, b) {
            var c;
            return p++, c = v(function() {
                delete t[c], e(a);
            }, b || 0), t[c] = !0, c;
            ...
            function b(b, d) {
                ...
                return a[b] = {
                    put: function(a, b) {
                        ...
                        return C(b) ? void 0 : (a in l || g++, l[a] = b, g > k && this.remove(n.key), b);
                    },
                    get: function(a) {
                        if (k < Number.MAX_VALUE) {
                            var b = m[a];
                    ...
                    remove: function(a) {
                        if (k < Number.MAX_VALUE) {
                            var b = m[a];
                            if (!b) return;
                            b == r && (r = b.p), b == n && (n = b.n), f(b.n, b.p), delete m[a];
                        }
                        delete l[a], g--;
                    },
                    removeAll: function() {
    ...
    function Bc(b, a) {
        ...
        this.directive = function n(a, f) {
            return Ma(a, "directive"), O(a) ? (d(a), Sb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], 
            b.factory(a + "Directive", [ "$injector", "$exceptionHandler", function(b, d) {
                var f = [];
                return q(e[a], function(e, g) {
                    try {
                        var h = b.invoke(e);
                        E(h) ? h = {
                            compile: ca(h)
                        } : !h.compile && h.link && (h.compile = ca(h.link)), h.priority = h.priority || 0, 
        ...
        this.debugInfoEnabled = function(a) {
            ...
            function N(a, b, c, d, e) {
                ...
                return function(b, c, d) {
                    ...
                    g || (g = (d = d && d[0]) && "foreignobject" !== sa(d) && d.toString().match(/SVG/) ? "svg" : "html"), 
                    d = "html" !== g ? z(T(g, z("<div>").append(a).html())) : c ? Ka.clone.call(a) : a, 
                    h) for (var l in h) d.data("$" + l + "Controller", h[l].instance);
                    return N.$$addScopeInfo(d, b), c && c(d, b), f && f(b, d, d, e), d;
                };
            }
            function Y(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (n = 0, m = h.length; m > n; ) l = u[h[n++]], c = h[n++], f = h[n++], c ? (c.scope ? (k = a.$new(), 
                    N.$$addScopeInfo(z(l), k)) : k = a, v = c.transcludeOnThisElement ? $(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? $(a, b) : null, 
                    c(f, k, l, d, v)) : f && f(a, l.childNodes, s, e);
                }
                for (var l, k, n, m, p, h = [], v = 0; v < a.length; v++) l = new $b(), k = W(a[v], [], l, 0 === v ? d : s, e), 
                ...
                (f || l) && (h.push(v, f, l), m = !0, p = p || f), f = null;
                return m ? g : null;
            }
            function $(a, b, c, d) {
            ...
            function W(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                  case ma:
                    C(b, va(sa(a)), "E", d, e);
                    for (var k, n, m, p = a.attributes, v = 0, u = p && p.length; u > v; v++) {
                        var B = !1, P = !1;
                        k = p[v], l = k.name, n = U(k.value), k = va(l), (m = ac.test(k)) && (l = l.replace(Wc, "").substr(8).replace(/_(.)/g, function(a, b) {
                            return b.toUpperCase();
                        }));
                        var M = k.replace(/(Start|End)$/, "");
                        F(M) && k === M + "Start" && (B = l, P = l.substr(0, l.length - 5) + "end", l = l.substr(0, l.length - 6)), 
                        k = va(l.toLowerCase()), h[k] = l, (m || !c.hasOwnProperty(k)) && (c[k] = n, Qc(a, k) && (c[k] = !0)), 
                        R(a, b, n, k, m), C(b, k, "A", d, e, B, P);
                    }
                    if (a = a.className, I(a) && (a = a.animVal), O(a) && "" !== a) for (;l = g.exec(a); ) k = va(l[2]), 
                    C(b, k, "C", d, e) && (c[k] = U(l[3])), a = a.substr(l.index + l[0].length);
                    break;
                  ...
                  case 8:
                    try {
                        (l = f.exec(a.nodeValue)) && (k = va(l[1]), C(b, k, "M", d, e) && (c[k] = U(l[2])));
                    } catch (t) {}
                }
                return b.sort(xa), b;
            }
            function S(a, b, c) {
                ...
                if (b && a.hasAttribute && a.hasAttribute(b)) {
                    do {
                        ...
                        a.nodeType == ma && (a.hasAttribute(b) && e++, a.hasAttribute(c) && e--), d.push(a), 
                        a = a.nextSibling;
                    } while (e > 0);
                } else d.push(a);
                return z(d);
            ...
            function Fa(a, b, c) {
                return function(d, e, f, g, h) {
                    return e = S(e[0], b, c), a(d, e, f, g, h);
                };
            }
            function y(a, d, e, f, g, h, k, n, m) {
                function B(a, b, c, d) {
                    a && (c && (a = Fa(a, c, d)), a.require = K.require, a.directiveName = ia, (J === K || K.$$isolateScope) && (a = X(a, {
                        isolateScope: !0
                    })), k.push(a)), b && (c && (b = Fa(b, c, d)), b.require = K.require, b.directiveName = ia, 
                    (J === K || K.$$isolateScope) && (b = X(b, {
                        isolateScope: !0
                    })), n.push(b));
                }
                function P(a, b, c, d) {
                    var e, k, f = "data", g = !1, h = c;
                    if (O(b)) {
                        if (k = b.match(l), b = b.substring(k[0].length), k[3] && (k[1] ? k[3] = null : k[1] = k[3]), 
                        "^" === k[1] ? f = "inheritedData" : "^^" === k[1] && (f = "inheritedData", h = c.parent()), 
                        "?" === k[2] && (g = !0), e = null, d && "data" === f && (e = d[b]) && (e = e.instance), 
                        e = e || h[f]("$" + b + "Controller"), !e && !g) throw da("ctreq", b, a);
                        return e || null;
                    }
                    return w(b) && (e = [], q(b, function(b) {
                        e.push(P(a, b, c, d));
                    })), e;
                }
                function M(a, c, f, g, h) {
                    function l(a, b, c) {
                        var d;
                        return Va(a) || (c = b, b = a, a = s), A && (d = G), c || (c = A ? S.parent() : S), 
                        h(a, b, d, c, Zb);
                    }
                    var m, v, B, D, G, ib, S, W;
                    if (d === f ? (W = e, S = e.$$element) : (S = z(f), W = new $b(S, e)), J && (D = c.$new(!0)), 
                    h && (ib = l, ib.$$boundTransclude = h), H && ($ = {}, G = {}, q(H, function(a) {
                        var b = {
                        ...
                        B = a.controller, "@" == B && (B = W[a.name]), b = p(B, b, !0, a.controllerAs), 
                        G[a.name] = b, A || S.data("$" + a.name + "Controller", b.instance), $[a.name] = b;
                    })), J) {
                        N.$$addScopeInfo(S, D, !0, !(Y && (Y === J || Y === J.$$originalDirective))), N.$$addScopeClass(S, !0), 
                        g = $ && $[J.name];
                        var ua = D;
                        g && g.identifier && !0 === J.bindToController && (ua = g.instance), q(D.$$isolateBindings = J.$$isolateBindings, function(a, d) {
                            var g, h, k, l, e = a.attrName, f = a.optional;
                            switch (a.mode) {
                              case "@":
                                W.$observe(e, function(a) {
                                    ua[d] = a;
                                }), W.$$observers[e].$$scope = c, W[e] && (ua[d] = b(W[e])(c));
                                break;

                              case "=":
                                if (f && !W[e]) break;
                                h = t(W[e]), l = h.literal ? fa : function(a, b) {
                                    return a === b || a !== a && b !== b;
                                }, k = h.assign || function() {
                                    throw g = ua[d] = h(c), da("nonassign", W[e], J.name);
                                }, g = ua[d] = h(c), f = function(a) {
                                    return l(a, ua[d]) || (l(a, g) ? k(c, a = ua[d]) : ua[d] = a), g = a;
                                }, f.$stateful = !0, f = a.collection ? c.$watchCollection(W[e], f) : c.$watch(t(W[e], f), null, h.literal), 
                                D.$on("$destroy", f);
                                break;
                    ...
                    for ($ && (q($, function(a) {
                        a();
                    }), $ = null), g = 0, m = k.length; m > g; g++) v = k[g], Xc(v, v.isolateScope ? D : c, S, W, v.require && P(v.directiveName, v.require, S, G), ib);
                    var Zb = c;
                    for (J && (J.template || null === J.templateUrl) && (Zb = D), a && a(Zb, f.childNodes, s, h), 
                    g = n.length - 1; g >= 0; g--) v = n[g], Xc(v, v.isolateScope ? D : c, S, W, v.require && P(v.directiveName, v.require, S, G), ib);
                }
                m = m || {};
                for (var G, $, K, ia, F, xa, D = -Number.MAX_VALUE, H = m.controllerDirectives, J = m.newIsolateScopeDirective, Y = m.templateDirective, Ga = m.nonTlbTranscludeDirective, C = !1, Yb = !1, A = m.hasElementTranscludeDirective, x = e.$$element = z(d), gb = f, qa = 0, L = a.length; L > qa; qa++) {
                    K = a[qa];
                    var R = K.$$start, jb = K.$$end;
                    if (R && (x = S(d, R, jb)), F = s, D > K.priority) break;
                    if ((F = K.scope) && (K.templateUrl || (I(F) ? (Oa("new/isolated scope", J || G, K, x), 
                    J = K) : Oa("new/isolated scope", J, K, x)), G = G || K), ia = K.name, !K.templateUrl && K.controller && (F = K.controller, 
                    H = H || {}, Oa("'" + ia + "' controller", H[ia], K, x), H[ia] = K), (F = K.transclude) && (C = !0, 
                    K.$$tlb || (Oa("transclusion", Ga, K, x), Ga = K), "element" == F ? (A = !0, D = K.priority, 
                    F = x, x = e.$$element = z(V.createComment(" " + ia + ": " + e[ia] + " ")), d = x[0], 
                    Q(g, Za.call(F, 0), d), gb = N(F, f, D, h && h.name, {
                        nonTlbTranscludeDirective: Ga
                    })) : (F = z(Vb(d)).contents(), x.empty(), gb = N(F, f))), K.template) if (Yb = !0, 
                    Oa("template", Y, K, x), Y = K, F = E(K.template) ? K.template(x, e) : K.template, 
                    F = Yc(F), K.replace) {
                        if (h = K, F = Tb.test(F) ? Zc(T(K.templateNamespace, U(F))) : [], d = F[0], 1 != F.length || d.nodeType !== ma) throw da("tplrt", ia, "");
                        Q(g, x, d), L = {
                            $attr: {}
                        }, F = W(d, [], L);
                        var tf = a.splice(qa + 1, a.length - (qa + 1));
                        J && hb(F), a = a.concat(F).concat(tf), Vc(e, L), L = a.length;
                    } else x.html(F);
                    if (K.templateUrl) Yb = !0, Oa("template", Y, K, x), Y = K, K.replace && (h = K), 
                    M = Xb(a.splice(qa, a.length - qa), x, e, g, C && gb, k, n, {
                ...
                return M.scope = G && !0 === G.scope, M.transcludeOnThisElement = C, M.elementTranscludeOnThisElement = A, 
                M.templateOnThisElement = Yb, M.transclude = gb, m.hasElementTranscludeDirective = A, 
                M;
            }
            function hb(a) {
            ...
            function Xb(a, b, c, e, f, g, h, k) {
                var n, m, l = [], p = b[0], v = a.shift(), u = Pb(v, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: v
                }), M = E(v.templateUrl) ? v.templateUrl(b, c) : v.templateUrl, D = v.templateNamespace;
                return b.empty(), d(B.getTrustedResourceUrl(M)).then(function(d) {
                    var B, P;
                    if (d = Yc(d), v.replace) {
                        if (d = Tb.test(d) ? Zc(T(D, U(d))) : [], B = d[0], 1 != d.length || B.nodeType !== ma) throw da("tplrt", v.name, M);
                        d = {
                            $attr: {}
                        }, Q(e, b, B);
                        var t = W(B, [], d);
                        I(v.scope) && hb(t), a = t.concat(a), Vc(c, d);
                    } else B = p, b.html(d);
                    for (a.unshift(u), n = y(a, B, c, f, b, v, g, h, k), q(e, function(a, c) {
                        a == B && (e[c] = b[0]);
                    }), m = Y(b[0].childNodes, f); l.length; ) {
                        d = l.shift(), P = l.shift();
                        var H = l.shift(), N = l.shift(), t = b[0];
                        if (!d.$$destroyed) {
                            if (P !== p) {
                                var J = P.className;
                                k.hasElementTranscludeDirective && v.replace || (t = Vb(B)), Q(H, z(P), t), G(z(t), J);
                            }
                            P = n.transcludeOnThisElement ? $(d, n.transclude, N) : N, n(m, d, t, e, P);
                        }
                    }
                    l = null;
                }), function(a, b, c, d, e) {
                    a = e, b.$$destroyed || (l ? l.push(b, c, d, a) : (n.transcludeOnThisElement && (a = $(b, n.transclude, e)), 
                    n(m, b, c, d, a)));
                };
            }
            function xa(a, b) {
            ...
            function ia(a, c) {
                ...
                d && a.push({
                    ...
                    compile: function(a) {
                        a = a.parent();
                        var b = !!a.length;
                        return b && N.$$addBindingClass(a), function(a, c) {
                            var e = c.parent();
                            b || N.$$addBindingClass(e), N.$$addBindingInfo(e, d.expressions), a.$watch(d, function(a) {
                                c[0].nodeValue = a;
                            });
                        };
                    }
                ...
                if (l) {
                    ...
                    c.push({
                        ...
                        compile: function() {
                            return {
                                pre: function(a, c, h) {
                                    if (c = h.$$observers || (h.$$observers = {}), k.test(e)) throw da("nodomevents");
                                    var n = h[e];
                                    n !== d && (l = n && b(n, !0, g, f), d = n), l && (h[e] = l(a), (c[e] || (c[e] = [])).$$inter = !0, 
            ...
            function Q(a, b, c) {
                ...
                for (f && f.replaceChild(c, d), a = V.createDocumentFragment(), a.appendChild(d), 
                z(c).data(z(d).data()), pa ? (Rb = !0, pa.cleanData([ d ])) : delete z.cache[d[z.expando]], 
                d = 1, e = b.length; e > d; d++) f = b[d], z(f).remove(), a.appendChild(f), delete b[d];
                b[0] = c, b.length = 1;
            }
            function X(a, b) {
                return x(function() {
            ...
            $b.prototype = {
                ...
                $updateClass: function(a, b) {
                    var c = $c(a, b);
                    c && c.length && M.addClass(this.$$element, c), (c = $c(b, a)) && c.length && M.removeClass(this.$$element, c);
                },
                $set: function(a, b, d, e) {
                    ...
                    g = sa(this.$$element), "a" === g && "href" === a || "img" === g && "src" === a) this[a] = b = D(b, "src" === a); else if ("img" === g && "srcset" === a) {
                        for (var g = "", h = U(b), l = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, l = /\s/.test(h) ? l : /(,)/, h = h.split(l), l = Math.floor(h.length / 2), k = 0; l > k; k++) var n = 2 * k, g = g + D(U(h[n]), !0), g = g + (" " + U(h[n + 1]));
                        h = U(h[2 * k]).split(/\s/), g += D(U(h[0]), !0), 2 === h.length && (g += " " + U(h[1])), 
                        this[a] = b = g;
                    }
                ...
                $observe: function(a, b) {
                    ...
                    return e.push(b), H.$evalAsync(function() {
            ...
            return N.$$addBindingInfo = m ? function(a, b) {
                var c = a.data("$binding") || [];
                w(b) ? c = c.concat(b) : c.push(b), a.data("$binding", c);
            } : A, N.$$addBindingClass = m ? function(a) {
                G(a, "ng-binding");
            } : A, N.$$addScopeInfo = m ? function(a, b, c, d) {
                a.data(c ? d ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", b);
            } : A, N.$$addScopeClass = m ? function(a, b) {
    ...
    function Ke() {
        ...
        this.register = function(a, c) {
            ...
            return function(g, h, l, k) {
                var m, r, n;
                if (l = !0 === l, k && O(k) && (n = k), O(g)) {
                    if (k = g.match(c), !k) throw vf("ctrlfmt", g);
                    r = k[1], n = n || k[3], g = b.hasOwnProperty(r) ? b[r] : Ac(h.$scope, r, !0) || (a ? Ac(e, r, !0) : s), 
                    La(g, r, !0);
                }
                return l ? (l = (w(g) ? g[g.length - 1] : g).prototype, m = Object.create(l || null), 
                n && f(h, n, m, r || g.name), x(function() {
                    return d.invoke(g, m, h, r), m;
                }, {
                    instance: m,
                    identifier: n
                })) : (m = d.instantiate(g, h, r), n && f(h, n, m, r || g.name), m);
            };
        } ];
    }
    function Le() {
    ...
    function bc(b, a) {
        if (O(b)) {
            ...
            if (c) {
                ...
                (d = d && 0 === d.indexOf(ad)) || (d = (d = c.match(xf)) && yf[d[0]].test(c)), d && (b = tc(c));
            }
        }
        return b;
    }
    function bd(b) {
        var c, d, e, a = ga();
        return b ? (q(b.split("\n"), function(b) {
            e = b.indexOf(":"), c = L(U(b.substr(0, e))), d = U(b.substr(e + 1)), c && (a[c] = a[c] ? a[c] + ", " + d : d);
        }), a) : a;
    }
    function cd(b) {
        var a = I(b) ? b : s;
        return function(c) {
            return a || (a = bd(b)), c ? (c = a[L(c)], void 0 === c && (c = null), c) : a;
        };
    }
    function dd(b, a, c, d) {
        return E(d) ? d(b, a, c) : (q(d, function(d) {
            b = d(b, a, c);
        }), b);
    }
    function Pe() {
        var b = this.defaults = {
            ...
            transformRequest: [ function(a) {
                return I(a) && "[object File]" !== Aa.call(a) && "[object Blob]" !== Aa.call(a) && "[object FormData]" !== Aa.call(a) ? $a(a) : a;
            } ],
            headers: {
                common: {
        ...
        this.$get = [ "$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(d, e, f, g, h, l) {
            function k(a) {
                function c(a) {
                    var b = x({}, a);
                    return b.data = a.data ? dd(a.data, a.headers, a.status, e.transformResponse) : a.data, 
                ...
                e.headers = function(a) {
                    var f, g, c = b.headers, e = x({}, a.headers), c = x({}, c.common, c[L(a.method)]);
                    a: for (f in c) {
                        a = L(f);
                ...
                return g.success = function(a) {
                    return La(a, "fn"), g.then(function(b) {
                        a(b.data, b.status, b.headers, e);
                    }), g;
                }, g.error = function(a) {
                    return La(a, "fn"), g.then(null, function(b) {
                        a(b.data, b.status, b.headers, e);
                    }), g;
                }, g;
            }
            function m(c, f) {
                function l(b, c, d, e) {
                    ...
                    D && (b >= 200 && 300 > b ? D.put(q, [ b, c, bd(d), e ]) : D.remove(q)), a ? g.$applyAsync(f) : (f(), 
                    g.$$phase || g.$apply());
                }
                function m(a, b, d, e) {
                    b = Math.max(b, 0), (b >= 200 && 300 > b ? B.resolve : B.reject)({
                        data: a,
                        status: b,
                        headers: cd(d),
                        config: c,
                ...
                function u(a) {
                    m(a.data, a.status, oa(a.headers()), a.statusText);
                }
                function J() {
                    var a = k.pendingRequests.indexOf(c);
                    -1 !== a && k.pendingRequests.splice(a, 1);
                }
                var D, G, B = h.defer(), M = B.promise, N = c.headers, q = r(c.url, c.params);
                return k.pendingRequests.push(c), M.then(J, J), !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (D = I(c.cache) ? c.cache : I(b.cache) ? b.cache : n), 
                D && (G = D.get(q), y(G) ? G && E(G.then) ? G.then(u, u) : w(G) ? m(G[1], G[0], oa(G[2]), G[3]) : m(G, 200, {}, "OK") : D.put(q, M)), 
                C(G) && ((G = ed(c.url) ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName] : s) && (N[c.xsrfHeaderName || b.xsrfHeaderName] = G), 
                d(c.method, q, f, l, N, c.timeout, c.withCredentials, c.responseType)), M;
            }
            function r(a, b) {
                if (!b) return a;
                var c = [];
                return Jd(b, function(a, b) {
                    null === a || C(a) || (w(a) || (a = [ a ]), q(a, function(a) {
                        I(a) && (a = ea(a) ? a.toISOString() : $a(a)), c.push(Ca(b) + "=" + Ca(a));
                    }));
    ...
    function Af(b, a, c, d, e) {
        ...
        return function(e, h, l, k, m, r, n, u) {
            ...
            function P(a, d, e, f, g) {
                B !== s && c.cancel(B), p = H = null, a(d, e, f, g), b.$$completeOutstandingRequest(A);
            }
            if (b.$$incOutstandingRequestCount(), h = h || b.url(), "jsonp" == L(e)) {
                var t = "_" + (d.counter++).toString(36);
                d[t] = function(a) {
                    d[t].data = a, d[t].called = !0;
                };
                var p = f(h.replace("JSON_CALLBACK", "angular.callbacks." + t), t, function(a, b) {
                    P(k, a, d[t].data, "", b), d[t] = A;
                });
            } else {
                var H = a();
                if (H.open(e, h, !0), q(m, function(a, b) {
                    y(a) && H.setRequestHeader(b, a);
                }), H.onload = function() {
                    var a = H.statusText || "", b = "response" in H ? H.response : H.responseText, c = 1223 === H.status ? 204 : H.status;
                    0 === c && (c = b ? 200 : "file" == ya(h).protocol ? 404 : 0), P(k, c, b, H.getAllResponseHeaders(), a);
                }, e = function() {
                    P(k, -1, null, null, "");
                }, H.onerror = e, H.onabort = e, n && (H.withCredentials = !0), u) try {
                    H.responseType = u;
                } catch (J) {
                    if ("json" !== u) throw J;
                }
            ...
            if (r > 0) var B = c(v, r); else r && E(r.then) && r.then(v);
        };
    }
    function Ne() {
        var b = "{{", a = "}}";
        this.startSymbol = function(a) {
            ...
            function g(f, g, u, v) {
                ...
                v = !!v;
                for (var p, H, q = 0, B = [], M = [], D = f.length, G = [], N = []; D > q; ) {
                    if (-1 == (p = f.indexOf(b, q)) || -1 == (H = f.indexOf(a, p + h))) {
                        q !== D && G.push(P(f.substring(q)));
                        break;
                    }
                    q !== p && G.push(P(f.substring(q, p))), q = f.substring(p + h, H), B.push(q), M.push(c(q, t)), 
                    q = H + l, N.push(G.length), G.push("");
                }
                    ...
                    return x(function(a) {
                        ...
                        $$watchDelegate: function(a, b, c) {
                            ...
                            return a.$watchGroup(M, function(c, e) {
                                var f = Y(c);
                                E(b) && b.call(this, f, c !== e ? d : f, a), d = f;
                            }, c);
                        }
                    });
                }
        ...
        this.$get = [ "$rootScope", "$window", "$q", "$$q", function(b, a, c, d) {
            function e(e, h, l, k) {
                ...
                return l = y(l) ? l : 0, P.then(null, null, e), P.$$intervalId = m(function() {
                    v.notify(n++), l > 0 && n >= l && (v.resolve(n), r(P.$$intervalId), delete f[P.$$intervalId]), 
                    u || b.$apply();
                }, h), f[P.$$intervalId] = v, P;
            }
            var f = {};
    ...
    function fd(b, a) {
        var c = ya(b);
        a.$$protocol = c.protocol, a.$$host = c.hostname, a.$$port = aa(c.port) || Bf[c.protocol] || null;
    }
    function gd(b, a) {
        var c = "/" !== b.charAt(0);
        c && (b = "/" + b);
        ...
        a.$$search = vc(d.search), a.$$hash = decodeURIComponent(d.hash), a.$$path && "/" != a.$$path.charAt(0) && (a.$$path = "/" + a.$$path);
    }
    function wa(b, a) {
    ...
    function gc(b, a) {
        this.$$html5 = !0, a = a || "";
        var c = fc(b);
        fd(b, this), this.$$parse = function(a) {
            var b = wa(c, a);
            if (!O(b)) throw Hb("ipthprfx", a, c);
            gd(b, this), this.$$path || (this.$$path = "/"), this.$$compose();
        }, this.$$compose = function() {
            var a = Qb(this.$$search), b = this.$$hash ? "#" + sb(this.$$hash) : "";
            this.$$url = ec(this.$$path) + (a ? "?" + a : "") + b, this.$$absUrl = c + this.$$url.substr(1);
        }, this.$$parseLinkUrl = function(d, e) {
            if (e && "#" === e[0]) return this.hash(e.slice(1)), !0;
            var f, g;
            return (f = wa(b, d)) !== s ? (g = f, g = (f = wa(a, f)) !== s ? c + (wa("/", f) || f) : b + g) : (f = wa(c, d)) !== s ? g = c + f : c == d + "/" && (g = c), 
            g && this.$$parse(g), !!g;
        };
    }
    function hc(b, a) {
        ...
        fd(b, this), this.$$parse = function(d) {
            ...
            this.$$url = ec(this.$$path) + (c ? "?" + c : "") + e, this.$$absUrl = b + (this.$$url ? a + this.$$url : "");
    ...
    function hd(b, a) {
        ...
        this.$$parseLinkUrl = function(d, e) {
            if (e && "#" === e[0]) return this.hash(e.slice(1)), !0;
            var f, g;
            return b == Ea(d) ? f = d : (g = wa(c, d)) ? f = b + a + g : c === d + "/" && (f = c), 
            f && this.$$parse(f), !!f;
        }, this.$$compose = function() {
            var c = Qb(this.$$search), e = this.$$hash ? "#" + sb(this.$$hash) : "";
            this.$$url = ec(this.$$path) + (c ? "?" + c : "") + e, this.$$absUrl = b + a + this.$$url;
        };
    }
    function Ib(b) {
        return function() {
    ...
    function id(b, a) {
        return function(c) {
            return C(c) ? this[b] : (this[b] = a(c), this.$$compose(), this);
        };
    }
    function Re() {
        var b = "", a = {
        ...
        this.hashPrefix = function(a) {
            ...
            if (a.enabled) {
                ...
                n = r.substring(0, r.indexOf("/", r.indexOf("//") + 2)) + (m || "/"), m = e.history ? gc : hd;
            } else n = Ea(r), m = hc;
            k = new m(n, "#" + b), k.$$parseLinkUrl(r, r), k.$$state = d.state();
    ...
    function kb(b, a, c, d, e) {
        ka(b, e), ka(a, e), c = c.split(".");
        for (var f, g = 0; 1 < c.length; g++) {
            f = ra(c.shift(), e);
            var h = 0 === g && a && a[f] || b[f];
            h || (h = {}, b[f] = h), b = ka(h, e);
        }
        return f = ra(c.shift(), e), ka(b[f], e), b[f] = d;
    }
    function Pa(b) {
        return "constructor" == b;
    }
    function jd(b, a, c, d, e, f, g) {
        ra(b, f), ra(a, f), ra(c, f), ra(d, f), ra(e, f);
        var h = function(a) {
            return ka(a, f);
        }, l = g || Pa(b) ? h : na, k = g || Pa(a) ? h : na, m = g || Pa(c) ? h : na, r = g || Pa(d) ? h : na, n = g || Pa(e) ? h : na;
        return function(f, g) {
            var h = g && g.hasOwnProperty(b) ? g : f;
            return null == h ? h : (h = l(h[b]), a ? null == h ? s : (h = k(h[a]), c ? null == h ? s : (h = m(h[c]), 
            d ? null == h ? s : (h = r(h[d]), e ? null == h ? s : h = n(h[e]) : h) : h) : h) : h);
        };
    }
    function Cf(b, a) {
        return function(c, d) {
    ...
    function Df(b, a, c) {
        ...
        if (a.csp) f = 6 > h ? jd(g[0], g[1], g[2], g[3], g[4], c, d) : function(a, b) {
            var f, e = 0;
            do f = jd(g[e++], g[e++], g[e++], g[e++], g[e++], c, d)(a, b), b = s, a = f; while (h > e);
            return f;
        }; else {
            var l = "";
            d && (l += "s = eso(s, fe);\nl = eso(l, fe);\n");
            ...
            q(g, function(a, b) {
                ...
                (d || Pa(a)) && (e = "eso(" + e + ", fe)", k = !0), l += "if(s == null) return undefined;\ns=" + e + ";\n";
            }), l += "return s;", a = new Function("s", "l", "eso", "fe", l), a.toString = ca(l), 
            k && (a = Cf(a, c)), f = a;
        }
        ...
        this.$get = [ "$filter", "$sniffer", function(c, d) {
            ...
            function h(a, b, c, d) {
                ...
                if (1 === e.length) {
                    ...
                    return a.$watch(function(a) {
                        var b = e(a);
                        return g(b, l) || (h = d(a), l = b && jc(b)), h;
                    }, b, c);
                }
                for (var k = [], n = 0, m = e.length; m > n; n++) k[n] = g;
                return a.$watch(function(a) {
                    for (var b = !1, c = 0, f = e.length; f > c; c++) {
                        var l = e[c](a);
                        (b || (b = !g(l, k[c]))) && (k[c] = l && jc(l));
                    }
                    return b && (h = d(a)), h;
                }, b, c);
            }
            function l(a, b, c, d) {
                ...
                return e = a.$watch(function(a) {
                    ...
                    f = a, E(b) && b.apply(this, arguments), y(a) && d.$$postDigest(function() {
                        y(f) && e();
                    });
                }, c);
            }
            ...
            return function(d, f, g) {
                ...
                switch (typeof d) {
                  case "string":
                    s = d = d.trim();
                    var B = g ? a : b;
                    return p = B[s], p || (":" === d.charAt(0) && ":" === d.charAt(1) && (q = !0, d = d.substring(2)), 
                    g = g ? u : n, p = new kc(g), p = new lb(p, c, g).parse(d), p.constant ? p.$$watchDelegate = m : q ? (p = e(p), 
                    p.$$watchDelegate = p.literal ? k : l) : p.inputs && (p.$$watchDelegate = h), B[s] = p), 
                    r(p, f);
    ...
    function kd(b, a) {
        ...
        function f(c) {
            !c.processScheduled && c.pending && (c.processScheduled = !0, b(function() {
                var b, d, e;
                e = c.pending, c.processScheduled = !1, c.pending = s;
        ...
        d.prototype = {
            ...
            $$resolve: function(b) {
                ...
                try {
                    (I(b) || E(b)) && (d = b && b.then), E(d) ? (this.promise.$$state.status = -1, d.call(b, e[0], e[1], this.notify)) : (this.promise.$$state.value = b, 
    ...
    function ef() {
        this.$get = [ "$window", "$timeout", function(b, a) {
            ...
            function d(a) {
                var b = m.length;
                return k++, m.push(a), 0 === b && (l = h(c)), function() {
                    b >= 0 && (b = m[b] = null, 0 === --k && l && (l(), l = null, m.length = 0));
                };
            }
    ...
    function Ue() {
        function b(a) {
            function b() {
                ...
                this.$$listeners = {}, this.$$listenerCount = {}, this.$id = ++rb, this.$$ChildScope = null;
            }
        ...
        this.digestTtl = function(b) {
            ...
            m.prototype = {
                ...
                $new: function(a, c) {
                    var d;
                    return c = c || this, a ? (d = new m(), d.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = b(this)), 
                ...
                $watch: function(a, b, c) {
                    ...
                    return d = null, E(b) || (g.fn = A), f || (f = this.$$watchers = []), f.unshift(g), 
                    function() {
                        Xa(f, g), d = null;
                    };
                },
                ...
                $watchCollection: function(a, b) {
                    function c(a) {
                        ...
                        var b, d, g, h;
                        if (!C(e)) {
                            if (I(e)) if (Sa(e)) for (f !== n && (f = n, u = f.length = 0, k++), a = e.length, 
                    ...
                    c.$stateful = !0;
                    var e, f, g, d = this, l = 1 < b.length, k = 0, m = h(a, c), n = [], r = {}, p = !0, u = 0;
                    return this.$watch(m, function() {
                        if (p ? (p = !1, b(e, e, d)) : b(e, g, d), l) if (I(e)) if (Sa(e)) {
                            g = Array(e.length);
                ...
                $digest: function() {
                    var b, f, h, k, m, n, s, P, J, q = a, S = [];
                    r("$digest"), l.$$checkUrlChange(), this === t && null !== e && (l.defer.cancel(e), 
                    v()), d = null;
                    do {
                        for (n = !1, s = this; p.length; ) {
                            try {
                        ...
                        a: do {
                            if (k = s.$$watchers) for (m = k.length; m--; ) try {
                                if (b = k[m]) if ((f = b.get(s)) === (h = b.last) || (b.eq ? fa(f, h) : "number" == typeof f && "number" == typeof h && isNaN(f) && isNaN(h))) {
                                    if (b === d) {
                                        n = !1;
                                        break a;
                                    }
                                } else n = !0, d = b, b.last = b.eq ? Ba(f, null) : f, b.fn(f, h === u ? f : h, s), 
                                5 > q && (P = 4 - q, S[P] || (S[P] = []), S[P].push({
                ...
                $broadcast: function(a, b) {
                    ...
                    for (var h, l, f = Ya([ e ], arguments, 1); c = d; ) {
    ...
    function Xd() {
        ...
        this.aHrefSanitizationWhitelist = function(a) {
            ...
            return function(c, d) {
                var f, e = d ? a : b;
                return f = ya(c).href, "" === f || f.match(e) ? c : "unsafe:" + f;
            };
        };
    }
    function Hf(b) {
        ...
        if (O(b)) {
            ...
            return b = ld(b).replace("\\*\\*", ".*").replace("\\*", "[^:/.?&;]*"), new RegExp("^" + b + "$");
        }
    ...
    function Ye() {
        ...
        this.resourceUrlWhitelist = function(a) {
            return arguments.length && (b = md(a)), b;
        }, this.resourceUrlBlacklist = function(b) {
            return arguments.length && (a = md(b)), a;
            ...
            return h[la.HTML] = e(g), h[la.CSS] = e(g), h[la.URL] = e(g), h[la.JS] = e(g), h[la.RESOURCE_URL] = e(h[la.URL]), 
            {
                ...
                getTrusted: function(c, e) {
                    ...
                    if (c === la.RESOURCE_URL) {
                        var r, n, g = ya(e.toString()), u = !1;
                        for (r = 0, n = b.length; n > r; r++) if (d(b[r], g)) {
                            u = !0;
                            break;
                        }
                        if (u) for (r = 0, n = a.length; n > r; r++) if (d(a[r], g)) {
                            u = !1;
                            break;
                        }
                        if (u) return e;
    ...
    function Ze() {
        this.$get = [ "$window", "$document", function(b, a) {
            var g, c = {}, d = aa((/android (\d+)/.exec(L((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, h = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1, m = !1;
            if (l) {
                ...
                m = !!("animation" in l || g + "Animation" in l), !d || k && m || (k = O(f.body.style.webkitTransition), 
                m = O(f.body.style.webkitAnimation));
            }
            return {
    ...
    function af() {
        this.$get = [ "$templateCache", "$http", "$q", function(b, a, c) {
            function d(e, f) {
                ...
                return w(g) ? g = g.filter(function(a) {
                    return a !== bc;
                }) : g === bc && (g = null), a.get(e, {
                    cache: b,
                    transformResponse: g
    ...
    function ya(b) {
        return Qa && (X.setAttribute("href", b), b = X.href), X.setAttribute("href", b), 
        {
            href: X.href,
    ...
    function ed(b) {
        return b = O(b) ? ya(b) : b, b.protocol === nd.protocol && b.host === nd.host;
    }
    function df() {
        this.$get = ca(T);
    }
    function Ic(b) {
        ...
        } ], a("currency", od), a("date", pd), a("filter", If), a("json", Jf), a("limitTo", Kf), 
        a("lowercase", Lf), a("number", qd), a("orderBy", rd), a("uppercase", Mf);
    }
    function If() {
    ...
    function Nf(b, a, c) {
        var d = I(b) && "$" in b;
        return !0 === a ? a = fa : E(a) || (a = function(a, b) {
            return C(a) ? !1 : null === a || null === b ? a === b : I(a) || I(b) ? !1 : (a = L("" + a), 
            b = L("" + b), -1 !== a.indexOf(b));
        }), function(e) {
    ...
    function Ha(b, a, c, d, e) {
        ...
        switch (f) {
          case "object":
            ...
            if ("object" === g) {
                for (h in a) if (e = a[h], !E(e) && !C(e) && (f = "$" === h, !Ha(f ? b : b[h], e, c, f, f))) return !1;
                return !0;
            }
            return c(b, a);
    ...
    function od(b) {
        ...
        return function(b, d, e) {
            return C(d) && (d = a.CURRENCY_SYM), C(e) && (e = a.PATTERNS[1].maxFrac), null == b ? b : sd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(/\u00A4/g, d);
        };
    }
    function qd(b) {
        var a = b.NUMBER_FORMATS;
    ...
    function sd(b, a, c, d, e) {
        ...
        if (k) e > 0 && 1 > b && (h = b.toFixed(e), b = parseFloat(h)); else {
            g = (g.split(td)[1] || "").length, C(e) && (e = Math.min(Math.max(a.minFrac, g), a.maxFrac)), 
            b = +(Math.round(+(b.toString() + "e" + e)).toString() + "e" + -e);
            var g = ("" + b).split(td), k = g[0], g = g[1] || "", r = 0, n = a.lgSize, u = a.gSize;
            if (k.length >= n + u) for (r = k.length - n, m = 0; r > m; m++) 0 === (r - m) % u && 0 !== m && (h += c), 
            h += k.charAt(m);
            for (m = r; m < k.length; m++) 0 === (k.length - m) % n && 0 !== m && (h += c), 
            h += k.charAt(m);
            for (;g.length < e; ) g += "0";
    ...
    function pd(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                ...
                b[9] && (f = aa(b[9] + b[10]), g = aa(b[9] + b[11])), h.call(a, aa(b[1]), aa(b[2]) - 1, aa(b[3])), 
                f = aa(b[4] || 0) - f, g = aa(b[5] || 0) - g, h = aa(b[6] || 0), b = Math.round(1e3 * parseFloat("0." + (b[7] || 0))), 
                l.call(a, f, g, h, b);
            }
            return a;
        }
        ...
        return function(c, e, f) {
            var l, k, g = "", h = [];
            if (e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e, O(c) && (c = Of.test(c) ? aa(c) : a(c)), 
            Q(c) && (c = new Date(c)), !ea(c)) return c;
            for (;e; ) (k = Pf.exec(e)) ? (h = Ya(h, k, 1), e = h.pop()) : (h.push(e), e = null);
            return f && "UTC" === f && (c = new Date(c.getTime()), c.setMinutes(c.getMinutes() + c.getTimezoneOffset())), 
            q(h, function(a) {
                l = Qf[a], g += l ? l(c, b.DATETIME_FORMATS) : a.replace(/(^'|'$)/g, "").replace(/''/g, "'");
            }), g;
        };
    }
    function Jf() {
        return function(b, a) {
            return C(a) && (a = 2), $a(b, a);
        };
    }
    function Kf() {
        return function(b, a) {
            return Q(b) && (b = b.toString()), w(b) || O(b) ? (a = 1 / 0 === Math.abs(Number(a)) ? Number(a) : aa(a)) ? a > 0 ? b.slice(0, a) : b.slice(a) : O(b) ? "" : [] : b;
        };
    }
    function rd(b) {
        return function(a, c, d) {
            ...
            return Sa(a) ? (c = w(c) ? c : [ c ], 0 === c.length && (c = [ "+" ]), c = c.map(function(a) {
                var c = !1, d = a || na;
                if (O(a)) {
    ...
    function Ia(b) {
        return E(b) && (b = {
            link: b
        }), b.restrict = b.restrict || "AC", ca(b);
    }
    function wd(b, a, c, d, e) {
        var f = this, g = [], h = f.$$parentForm = b.parent().controller("form") || Lb;
        f.$error = {}, f.$$success = {}, f.$pending = s, f.$name = e(a.name || a.ngForm || "")(c), 
        ...
        h.$addControl(f), f.$rollbackViewValue = function() {
            ...
            d.removeClass(b, Ra), d.addClass(b, Mb), f.$dirty = !0, f.$pristine = !1, h.$setDirty();
        }, f.$setPristine = function() {
            d.setClass(b, Ra, Mb + " ng-submitted"), f.$dirty = !1, f.$pristine = !0, f.$submitted = !1, 
            q(g, function(a) {
                a.$setPristine();
            });
    ...
    function nb(b, a, c, d) {
        return function(e, f, g, h, l, k, m) {
            ...
            yd(e, f, g, h), mb(e, f, g, h, l, k);
            var v, u = h && h.$options && h.$options.timezone;
            if (h.$$parserName = b, h.$parsers.push(function(b) {
                return h.$isEmpty(b) ? null : a.test(b) ? (b = c(b, v), "UTC" === u && b.setMinutes(b.getMinutes() - b.getTimezoneOffset()), 
                b) : s;
    ...
    function zd(b, a, c, d, e) {
        if (y(d)) {
            if (b = b(d), !b.constant) throw F("ngModel")("constexpr", c, d);
            return b(a);
        }
        return e;
    }
    ...
    function xd(b) {
        ...
        function c(b, c) {
            b = b ? "-" + yc(b, "-") : "", a(ob + b, !0 === c), a(Ad + b, !1 === c);
        }
        var d = b.ctrl, e = b.$element, f = {}, g = b.set, h = b.unset, l = b.parentForm, k = b.$animate;
        f[Ad] = !(f[ob] = e.hasClass(ob)), d.$setValidity = function(b, e, f) {
            e === s ? (d.$pending || (d.$pending = {}), g(d.$pending, b, f)) : (d.$pending && h(d.$pending, b, f), 
            Bd(d.$pending) && (d.$pending = s)), Wa(e) ? e ? (h(d.$error, b, f), g(d.$$success, b, f)) : (g(d.$error, b, f), 
            h(d.$$success, b, f)) : (h(d.$error, b, f), h(d.$$success, b, f)), d.$pending ? (a(Cd, !0), 
            d.$valid = d.$invalid = s, c("", null)) : (a(Cd, !1), d.$valid = Bd(d.$error), d.$invalid = !d.$valid, 
            c("", d.$valid)), e = d.$pending && d.$pending[b] ? s : d.$error[b] ? !1 : d.$$success[b] ? !0 : null, 
    ...
    var Qa, z, pa, db, Sf = /^\/(.+)\/([a-z]*)$/, L = function(b) {
        return O(b) ? b.toLowerCase() : b;
    }, wc = Object.prototype.hasOwnProperty, vb = function(b) {
        return O(b) ? b.toUpperCase() : b;
    }, Za = [].slice, uf = [].splice, Tf = [].push, Aa = Object.prototype.toString, Ja = F("ng"), ba = T.angular || (T.angular = {}), rb = 0;
    Qa = V.documentMode, A.$inject = [], na.$inject = [];
    var Rb, w = Array.isArray, U = function(b) {
        return O(b) ? b.trim() : b;
    }, ld = function(b) {
    ...
    }, tb = [ "ng-", "data-ng-", "ng:", "x-ng-" ], Rd = /[A-Z]/g, zc = !1, ma = 1, ab = 3, Vd = {
        full: "1.3.16",
        major: 1,
        minor: 3,
        dot: 16,
    ...
    var Ka = R.prototype = {
        ...
        eq: function(b) {
            return z(b >= 0 ? this[b] : this[this.length + b]);
        },
        length: 0,
        push: Tf,
        sort: [].sort,
    ...
    q({
        ...
        hasClass: Bb,
        css: function(b, a, c) {
            return a = eb(a), y(c) ? void (b.style[a] = c) : b.style[a];
        },
        attr: function(b, a, c) {
            var d = b.nodeType;
            if (d !== ab && 2 !== d && 8 !== d) if (d = L(a), Fb[d]) {
                if (!y(c)) return b[a] || (b.attributes.getNamedItem(a) || A).specified ? d : s;
        ...
        html: function(b, a) {
            return C(a) ? b.innerHTML : (xb(b, !0), void (b.innerHTML = a));
        },
        empty: Oc
    }, function(b, a) {
        R.prototype[a] = function(a, d) {
            var e, f, g = this.length;
            if (b !== Oc && (2 == b.length && b !== Bb && b !== Nc ? a : d) === s) {
                if (I(a)) {
                    for (e = 0; g > e; e++) if (b === Wb) b(this[e], a); else for (f in a) b(this[e], f, a[f]);
                    return this;
                }
                for (e = b.$dv, g = e === s ? Math.min(g, 1) : g, f = 0; g > f; f++) {
                    var h = b(this[f], a, d);
                    e = e ? e + h : h;
                }
                return e;
        ...
        on: function a(c, d, e, f) {
            ...
            if (Jc(c)) {
                ...
                for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [ d ], l = g.length; l--; ) {
                    d = g[l];
                    var k = f[d];
                    k || (f[d] = [], "mouseenter" === d || "mouseleave" === d ? a(c, Uf[d], function(a) {
        ...
        off: Mc,
        one: function(a, c, d) {
            a = z(a), a.on(c, function f() {
                a.off(c, d), a.off(c, f);
            }), a.on(c, d);
        },
        replaceWith: function(a, c) {
            var d, e = a.parentNode;
            xb(a), q(new R(c), function(c) {
        ...
        R.prototype[c] = function(c, e, f) {
            for (var g, h = 0, l = this.length; l > h; h++) C(g) ? (g = a(this[h], c, e, f), 
            y(g) && (g = z(g))) : Lc(g, a(this[h], c, e, f));
            return y(g) ? g : this;
    ...
    var Uc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Vf = /,/, Wf = /^\s*(_?)(\S+?)\1\s*$/, Tc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Da = F("$injector");
    bb.$$annotate = function(a, c, d) {
        var e;
        if ("function" == typeof a) {
            if (!(e = a.$inject)) {
                if (e = [], a.length) {
                    if (c) throw O(d) && d || (d = a.name || rf(a)), Da("strictdi", d);
                    c = a.toString().replace(Tc, ""), c = c.match(Uc), q(c[1].split(Vf), function(a) {
    ...
    var Xf = F("$animate"), He = [ "$provide", function(a) {
        this.$$selectors = {}, this.register = function(c, d) {
            ...
            function g(a, c) {
                var d = [], e = [], f = ga();
                return q((a.attr("class") || "").split(/\s+/), function(a) {
                    f[a] = !0;
                }), q(c, function(a, c) {
                    var g = f[c];
            ...
            return {
                ...
                $$addClassImmediately: function(a, c, d) {
                    return a = z(a), c = O(c) ? c : w(c) ? c.join(" ") : "", q(a, function(a) {
                        Db(a, c);
                    }), k(a, d), l();
                },
                ...
                setClass: function(a, c, d, e) {
                    ...
                    return m ? e && m.options && (m.options = ba.extend(m.options || {}, e)) : (m = {
                        classes: {},
                        options: e
                    }, l = !0), e = m.classes, c = w(c) ? c : c.split(" "), d = w(d) ? d : d.split(" "), 
    ...
    var Wc = /^((?:x|data)[\:\-_])/i, vf = F("$controller"), ad = "application/json", cc = {
        ...
        search: function(a, c) {
            switch (arguments.length) {
              ...
              case 1:
                if (O(a) || Q(a)) a = a.toString(), this.$$search = vc(a); else {
    ...
    q([ hd, hc, gc ], function(a) {
        a.prototype = Object.create(Zf), a.prototype.state = function(c) {
            if (!arguments.length) return this.$$state;
            if (a !== gc || !this.$$html5) throw Hb("nostate");
            return this.$$state = C(c) ? null : c, this;
        };
    });
    ...
    var qb = x(ga(), {
        "+": function(a, c, d, e) {
            return d = d(a, c), e = e(a, c), y(d) ? y(e) ? d + e : d : y(e) ? e : s;
        },
        "-": function(a, c, d, e) {
    ...
    kc.prototype = {
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length; ) {
                ...
                this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += cg[g] || g, f = !1; else if ("\\" === g) f = !0; else {
    ...
    lb.ZERO = x(function() {
        ...
        functionCall: function(a, c) {
            ...
            return function(g, h) {
                ...
                if (ka(l, e), k) {
                    if (k.constructor === k) throw ja("isecfn", e);
    ...
    var Ff = ga(), Ef = ga(), Gf = Object.prototype.valueOf, za = F("$sce"), la = {
        ...
        JS: "js"
    }, da = F("$compile"), X = V.createElement("a"), nd = ya(T.location.href);
    Ic.$inject = [ "$provide" ], od.$inject = [ "$locale" ], qd.$inject = [ "$locale" ];
    var td = ".", Qf = {
        yyyy: Z("FullYear", 4),
        yy: Z("FullYear", 2, 0, !0),
        y: Z("FullYear", 1),
    ...
    q(Fb, function(a, c) {
        ...
        wb[c] = function() {
            return {
                priority: 100,
                link: function(a, e, f) {
                    return "ngPattern" === c && "/" == f.ngPattern.charAt(0) && (e = f.ngPattern.match(Sf)) ? void f.$set("ngPattern", new RegExp(e[1], e[2])) : void a.$watch(f[c], function(a) {
                        f.$set(c, a);
                    });
                }
            };
        ...
        wb[c] = function() {
            return {
                ...
                link: function(d, e, f) {
                    var g = a, h = a;
                    "href" === a && "[object SVGAnimatedString]" === Aa.call(e.prop("href")) && (h = "xlinkHref", 
    ...
    var Dd = function(a) {
                    ...
                    return {
                        pre: function(a, d, e, k) {
                            ...
                            f && (kb(a, null, k.$name, k, k.$name), e.$observe(f, function(c) {
                                ...
                                r.$removeControl(k), f && kb(a, null, e[f], s, k.$name), x(k, Lb);
                            });
                        }
                    };
                }
    ...
    }, Zd = Dd(), le = Dd(!0), Rf = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, dg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, eg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, fg = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Ed = /^(\d{4})-(\d{2})-(\d{2})$/, Fd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, oc = /^(\d{4})-W(\d\d)$/, Gd = /^(\d{4})-(\d\d)$/, Hd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Id = {
        text: function(a, c, d, e, f, g) {
            mb(a, c, d, e, f, g), mc(e);
        },
        date: nb("date", Ed, Nb(Ed, [ "yyyy", "MM", "dd" ]), "yyyy-MM-dd"),
        "datetime-local": nb("datetimelocal", Fd, Nb(Fd, "yyyy MM dd HH mm ss sss".split(" ")), "yyyy-MM-ddTHH:mm:ss.sss"),
        ...
        number: function(a, c, d, e, f, g) {
            if (yd(a, c, d, e), mb(a, c, d, e, f, g), e.$$parserName = "number", e.$parsers.push(function(a) {
                ...
                e.$validators.min = function(a) {
                    ...
                    y(a) && !Q(a) && (a = parseFloat(a, 10)), h = Q(a) && !isNaN(a) ? a : s, e.$validate();
                });
            }
            if (y(d.max) || d.ngMax) {
                var l;
                e.$validators.max = function(a) {
                    return e.$isEmpty(a) || C(l) || l >= a;
                }, d.$observe("max", function(a) {
                    y(a) && !Q(a) && (a = parseFloat(a, 10)), l = Q(a) && !isNaN(a) ? a : s, e.$validate();
                });
            }
        },
        url: function(a, c, d, e, f, g) {
            mb(a, c, d, e, f, g), mc(e), e.$$parserName = "url", e.$validators.url = function(a, c) {
                var d = a || c;
                return e.$isEmpty(d) || dg.test(d);
            };
        },
        email: function(a, c, d, e, f, g) {
            mb(a, c, d, e, f, g), mc(e), e.$$parserName = "email", e.$validators.email = function(a, c) {
                var d = a || c;
                return e.$isEmpty(d) || eg.test(d);
            };
        },
        radio: function(a, c, d, e) {
            C(d.name) && c.attr("name", ++rb), c.on("click", function(a) {
        ...
        reset: A,
        file: A
    }, Cc = [ "$browser", "$sniffer", "$filter", "$parse", function(a, c, d, e) {
        return {
            restrict: "E",
            require: [ "?ngModel" ],
            link: {
    ...
    var ne = [ "$animate", function(a) {
        return {
            ...
            link: function(c, d, e, f, g) {
                ...
                c.$watch(e.ngIf, function(c) {
                    c ? l || g(function(c, f) {
                        l = f, c[c.length++] = V.createComment(" end ngIf: " + e.ngIf + " "), h = {
                            clone: c
        ...
        return {
            ...
            compile: function(f, g) {
                ...
                return function(f, g, n, q, v) {
                    var t, p, H, s = 0, J = function() {
                        p && (p.remove(), p = null), t && (t.$destroy(), t = null), H && (d.leave(H).then(function() {
                            p = null;
                        }), p = H, H = null);
                    };
                    f.$watch(e.parseAsResourceUrl(h), function(e) {
                        ...
                        e ? (a(e, !0).then(function(a) {
                            if (n === s) {
                                var c = f.$new();
                                q.template = a, a = v(c, function(a) {
                                    J(), d.enter(a, null, g).then(h);
                                }), t = c, H = a, t.$emit("$includeContentLoaded", e), f.$eval(l);
                            }
                        }, function() {
        ...
        return {
            ...
            link: function(a, c, d, e) {
                ...
                e.$parsers.push(function(a) {
                    if (!C(a)) {
                        var c = [];
                        return a && q(a.split(h), function(a) {
                            a && c.push(g ? U(a) : a);
                        }), c;
                    }
                }), e.$formatters.push(function(a) {
    ...
    }, ob = "ng-valid", Ad = "ng-invalid", Ra = "ng-pristine", Mb = "ng-dirty", Cd = "ng-pending", Ob = new F("ngModel"), ig = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, c, d, e, f, g, h, l, k, m) {
        ...
        this.$valid = !0, this.$invalid = !1, this.$error = {}, this.$$success = {}, this.$pending = s, 
        this.$name = m(d.name || "", !1)(a);
        var t, r = f(d.ngModel), n = r.assign, u = r, v = n, P = null, p = this;
        ...
        xd({
            ...
            p.$dirty = !1, p.$pristine = !0, g.removeClass(e, Mb), g.addClass(e, Ra);
        }, this.$setDirty = function() {
            p.$dirty = !0, p.$pristine = !1, g.removeClass(e, Ra), g.addClass(e, Mb), H.$setDirty();
            ...
            function e() {
                var d = !0;
                return q(p.$validators, function(e, f) {
                    var h = e(a, c);
                    d = d && h, g(f, h);
                }), d ? !0 : (q(p.$asyncValidators, function(a, c) {
                    g(c, null);
                }), !1);
            }
            function f() {
            ...
            (function() {
                ...
                return t !== s ? (t || (q(p.$validators, function(a, c) {
                    g(c, null);
            ...
            if (t = C(c) ? s : !0) for (var d = 0; d < p.$parsers.length; d++) if (c = p.$parsers[d](c), 
            C(c)) {
                t = !1;
                break;
            }
            ...
            v(a, p.$modelValue), q(p.$viewChangeListeners, function(a) {
                try {
                    a();
                } catch (d) {
                    c(d);
            ...
            if (c !== p.$modelValue && (p.$modelValue === p.$modelValue || c === c)) {
                p.$modelValue = p.$$rawModelValue = c, t = s;
        ...
        return {
            ...
            priority: 1,
            compile: function(c) {
                return c.addClass(Ra).addClass("ng-untouched").addClass(ob), {
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, c) {
                var d = this;
                this.$options = a.$eval(c.ngModelOptions), this.$options.updateOn !== s ? (this.$options.updateOnDefault = !1, 
                this.$options.updateOn = U(this.$options.updateOn.replace(jg, function() {
        ...
        return {
            ...
            link: function(f, g, h) {
                ...
                var p, k = h.count, m = h.$attr.when && g.attr(h.$attr.when), r = h.offset || 0, n = f.$eval(m) || {}, u = {}, m = c.startSymbol(), s = c.endSymbol(), y = m + k + "-" + r + s, t = ba.noop;
                q(h, function(a, c) {
                    var d = e.exec(c);
                    ...
                    c = parseFloat(c);
                    var d = isNaN(c);
                    d || c in n || (c = a.pluralCat(c - r)), c === p || d && isNaN(p) || (t(), t = f.$watch(u[c], l), 
                    p = c);
                });
            }
        };
        ...
        var d = F("ngRepeat"), e = function(a, c, d, e, k, m, q) {
            a[d] = e, k && (a[k] = m), a.$index = c, a.$first = 0 === c, a.$last = c === q - 1, 
        ...
        return {
            ...
            compile: function(f, g) {
                ...
                return u ? t = a(u) : (H = function(a, c) {
                    return Na(c);
                }, F = function(a) {
                    return a;
                }), function(a, f, g, k, m) {
                    t && (p = function(c, d, e) {
                        return y && (B[y] = c), B[v] = d, B.$index = e, t(a, B);
                    });
                    var u = ga();
                    a.$watchCollection(r, function(g) {
                        var k, r, G, x, C, A, N, E, w, I, t = f[0], B = ga();
                        if (n && (a[n] = g), Sa(g)) E = g, r = p || H; else {
                            r = p || F, E = [];
                            for (I in g) g.hasOwnProperty(I) && "$" != I.charAt(0) && E.push(I);
                            E.sort();
                        }
                        for (x = E.length, I = Array(x), k = 0; x > k; k++) if (C = g === E ? k : E[k], 
                        A = g[C], N = r(C, A, k), u[N]) w = u[N], delete u[N], B[N] = w, I[k] = w; else {
                        ...
                        for (G in u) {
                            if (w = u[G], N = ub(w.clone), c.leave(N), N[0].parentNode) for (k = 0, r = N.length; r > k; k++) N[k].$$NG_REMOVED = !0;
                            w.scope.$destroy();
                        }
                        for (k = 0; x > k; k++) if (C = g === E ? k : E[k], A = g[C], w = I[k], w.scope) {
                            G = t;
                            do G = G.nextSibling; while (G && G.$$NG_REMOVED);
                            w.clone[0] != G && c.move(ub(w.clone), null, z(t)), t = w.clone[w.clone.length - 1], 
                            e(w.scope, k, v, A, y, C, x);
                        } else m(function(a, d) {
                            w.scope = d;
                            var f = l.cloneNode(!1);
                            a[a.length++] = f, c.enter(a, null, z(t)), t = f, w.clone = a, B[w.id] = w, e(w.scope, k, v, A, y, C, x);
                        });
                        u = B;
                    });
                };
            ...
            link: function(c, d, e, f) {
                ...
                c.$watch(e.ngSwitch || e.on, function(c) {
                    ...
                    for (d = l.length = 0, e = k.length; e > d; ++d) {
                        var s = ub(h[d].clone);
                        k[d].$destroy(), (l[d] = a.leave(s)).then(m(l, d));
                    }
                    h.length = 0, k.length = 0, (g = f.cases["!" + c] || f.cases["?"]) && q(g, function(c) {
                        c.transclude(function(d, e) {
                            k.push(e);
                            var f = c.element;
                            d[d.length++] = V.createComment(" end ngSwitchWhen: "), h.push({
                                clone: d
        ...
        return {
            ...
            controller: [ "$element", "$scope", "$attrs", function(a, c, d) {
                ...
                l.databound = d.ngModel, l.init = function(a, c, d) {
                    ...
                    Ma(c, '"option value"'), k[c] = !0, m.$viewValue == c && (a.val(c), q.parent() && q.remove()), 
                    ...
                    c = "? " + Na(c) + " ?", q.val(c), a.prepend(q), a.val(c), q.prop("selected", !0);
            ...
            link: function(e, g, h, l) {
                function k(a, c, d, e) {
                    d.$render = function() {
                        ...
                        a.$apply(function() {
                            B.parent() && B.remove(), d.$setViewValue(c.val());
                        });
                    });
                }
                function m(a, c, d) {
                ...
                function r(e, f, g) {
                    ...
                    function k(a) {
                        ...
                        } else c = new fb(a); else L && (a = h(L, null, a));
                        return function(d, e) {
                            var f;
                            return f = L ? L : z ? z : D, u ? y(c.remove(h(f, d, e))) : a === h(f, d, e);
                        };
                    }
                    function l() {
                    ...
                    function r() {
                        ...
                        s = g.$viewValue, t = O(e) || [];
                        var w, z, E, D, A = I ? Object.keys(t).sort() : t, S = {};
                        v = k(s);
                        var V, X, Q = !1;
                        for (R = {}, D = 0; E = A.length, E > D; D++) w = D, I && (w = A[D], "$" === w.charAt(0)) || (z = t[w], 
                        d = h(M, w, z) || "", (l = a[d]) || (l = a[d] = [], c.push(d)), d = v(w, z), Q = Q || d, 
                        z = h(B, w, z), z = y(z) ? z : "", X = L ? L(e, U) : I ? A[D] : D, L && (R[X] = w), 
                        l.push({
                            id: X,
                            label: z,
                            selected: d
                        }));
                        for (u || (x || null === s ? a[""].unshift({
                            id: "",
                            label: "",
                            selected: !Q
                        }) : Q || a[""].unshift({
                            ...
                            label: "",
                            selected: !0
                        })), w = 0, A = c.length; A > w; w++) {
                            for (d = c[w], l = a[d], T.length <= w ? (s = {
                                element: F.clone().attr("label", d),
                                label: l.label
                            }, t = [ s ], T.push(t), f.append(s.element)) : (t = T[w], s = t[0], s.label != d && s.element.attr("label", s.label = d)), 
                            Q = null, D = 0, E = l.length; E > D; D++) d = l[D], (v = t[D + 1]) ? (Q = v.element, 
                            v.label !== d.label && (m(S, v.label, !1), m(S, d.label, !0), Q.text(v.label = d.label), 
                            Q.prop("label", v.label)), v.id !== d.id && Q.val(v.id = d.id), Q[0].selected !== d.selected && (Q.prop("selected", v.selected = d.selected), 
                            Qa && Q.prop("selected", v.selected))) : ("" === d.id && x ? V = x : (V = C.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).prop("label", d.label).text(d.label), 
                            t.push(v = {
                                element: V,
                                label: d.label,
                                id: d.id,
                        ...
                        for (;T.length > w; ) {
                            for (l = T.pop(), D = 1; D < l.length; ++D) m(S, l[D].label, !1);
                            l[0].element.remove();
                        }
                        q(S, function(a, c) {
                            a > 0 ? n.addOption(c) : 0 > a && n.removeOption(c);
                        });
                    }
                    var t;
                    ...
                    x && (a(x)(e), x.removeClass("ng-scope"), x.remove()), f.empty(), f.on("change", function() {
                        e.$apply(function() {
                            var c, a = O(e) || [];
                            if (u) c = [], q(f.val(), function(d) {
                                d = L ? R[d] : d, c.push("?" === d ? s : "" === d ? null : h(z ? z : D, d, a[d]));
                            }); else {
                    ...
                    }), g.$render = r, e.$watchCollection(O, l), e.$watchCollection(function() {
                        var c, a = O(e);
                        if (a && w(a)) {
                            c = Array(a.length);
                            for (var d = 0, f = a.length; f > d; d++) c[d] = h(B, d, a[d]);
                ...
                if (l[1]) {
                    var n = l[0];
                    l = l[1];
                    var t, u = h.multiple, v = h.ngOptions, x = !1, p = !1, C = z(V.createElement("option")), F = z(V.createElement("optgroup")), B = C.clone();
                    h = 0;
                    for (var A = g.children(), E = A.length; E > h; h++) if ("" === A[h].value) {
                        t = x = A.eq(h);
                        break;
                    }
                    n.init(l, x, B), u && (l.$isEmpty = function(a) {
                        return !a || 0 === a.length;
            ...
            link: function(a, c, d, e) {
                if (e) {
                    ...
                    d.$observe("pattern", function(a) {
                        if (O(a) && 0 < a.length && (a = new RegExp("^" + a + "$")), a && !a.test) throw F("ngPattern")("noregexp", g, a, ta(c));
                        f = a || s, e.$validate();
    ...
    T.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (Sd(), 
    Ud(ba), z(V).ready(function() {
        Od(V, xc);
    }));
    ...
    $.fn.bootstrapFileInput = function() {
        this.each(function(i, elem) {
            ...
            if ("undefined" == typeof $elem.attr("data-bfi-disabled")) {
                ...
                var className = "";
                $elem.attr("class") && (className = " " + $elem.attr("class")), $elem.wrap('<a class="file-input-wrapper btn btn-default ' + className + '"></a>').parent().prepend($("<span></span>").html(buttonWord));
            }
            ...
            $(".file-input-wrapper").mousemove(function(cursor) {
                ...
                var fileName;
                if (fileName = $(this).val(), $(this).parent().next(".file-input-name").remove(), 
                fileName = $(this).prop("files") && $(this).prop("files").length > 1 ? $(this)[0].files.length + " files" : fileName.substring(fileName.lastIndexOf("\\") + 1, fileName.length)) {
                    var selectedFileNamePlacement = $(this).data("filename-placement");
                    "inside" === selectedFileNamePlacement ? ($(this).siblings("span").html(fileName), 
                    $(this).attr("title", fileName)) : $(this).parent().after('<span class="file-input-name">' + fileName + "</span>");
                }
            });
        });
    };
...
+function($) {
    ...
    Alert.VERSION = "3.3.4", Alert.TRANSITION_DURATION = 150, Alert.prototype.close = function(e) {
    ...
    Modal.VERSION = "3.3.4", Modal.TRANSITION_DURATION = 300, Modal.BACKDROP_TRANSITION_DURATION = 150, 
    Modal.DEFAULTS = {
        backdrop: !0,
        keyboard: !0,
        show: !0
        ...
        this.$dialog.on("mousedown.dismiss.bs.modal", function() {
            ...
            that.adjustDialog(), transition && that.$element[0].offsetWidth, that.$element.addClass("in").attr("aria-hidden", !1), 
            that.enforceFocus();
        ...
        $(document).off("focusin.bs.modal"), this.$element.removeClass("in").attr("aria-hidden", !0).off("click.dismiss.bs.modal").off("mouseup.dismiss.bs.modal"), 
    ...
    var Tooltip = function(element, options) {
        ...
        this.hoverState = null, this.$element = null, this.init("tooltip", element, options);
    };
    Tooltip.VERSION = "3.3.4", Tooltip.TRANSITION_DURATION = 150, Tooltip.DEFAULTS = {
        animation: !0,
        placement: "top",
        selector: !1,
    ...
    Popover.VERSION = "3.3.4", Popover.DEFAULTS = $.extend({}, $.fn.tooltip.Constructor.DEFAULTS, {
        placement: "right",
        trigger: "click",
        content: "",
    ...
    ScrollSpy.VERSION = "3.3.4", ScrollSpy.DEFAULTS = {
        offset: 10
...
}(jQuery), void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0), function(e, t, n) {
    function r(n) {
        var r = t.console;
