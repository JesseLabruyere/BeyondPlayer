...
function renderPlaylistData(data) {
    for (var i = 0; i < data.length; i++) $("#playListView").append("<p>[id:] " + data[i].id + " [name:] " + data[i].listName + "</p>");
}
...
}), app.controller("uploadController", function($scope) {}), app.controller("registrationController", function($scope) {}), 
